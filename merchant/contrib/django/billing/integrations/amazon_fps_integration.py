...
from merchant.integrations.amazon_fps_integration import AmazonFpsIntegration as Integration
from merchant.contrib.django.billing.signals import (transaction_was_successful,
                             transaction_was_unsuccessful)
from merchant.contrib.django.billing.models import AmazonFPSResponse
