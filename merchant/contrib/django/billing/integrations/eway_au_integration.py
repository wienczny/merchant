...
from merchant.integrations.eway_au_integration import EwayAuIntegration as Integration
from merchant.contrib.django.billing.forms.eway_au_forms import EwayAuForm
