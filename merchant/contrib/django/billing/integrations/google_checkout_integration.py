...
from merchant.integrations.google_checkout_integration import GoogleCheckoutIntegration as Integration
from merchant.contrib.django.billing.models import GCNewOrderNotification
from merchant.contrib.django.billing import signals
