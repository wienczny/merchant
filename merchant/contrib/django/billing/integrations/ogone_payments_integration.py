...
from merchant.integrations.ogone_payments_integration import OgonePaymentsIntegration as Integration

from django_ogone.ogone import Ogone
from django_ogone.status_codes import (
    get_status_category, get_status_description,
